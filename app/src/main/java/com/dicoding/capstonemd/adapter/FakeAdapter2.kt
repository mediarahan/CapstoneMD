...
class FakeAdapter2 : ListAdapter<Fake, FakeAdapter2.ViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = SimpleRecommendationRv2Binding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val binding: SimpleRecommendationRv2Binding):RecyclerView.ViewHolder(binding.root) {
